    ...
    return (
        <div>
            ...
            <img src="./Assets/dl.png" class="mt-6 ml-32"></img>
                ...
                <img src="./Assets/bellicon.png" style={{marginLeft:1050}} class="relative left-64 bottom-16"></img>
                <img src="./Assets/user.png" style={{marginLeft:1120}} class="relative left-60 bottom-24 w-8"></img> 
            </div>
            ...
            <div>
               ...
               <div class="clear-left relative top-8">
                   ...
                   <hr class="border-2 border-blue-500 w-20 ml-96 relative left-36 top-4"></hr>
                   <hr class="mt-4"></hr>
               </div><br></br><br></br>
               <div>
                   <img src="./Assets/user.png" class="ml-20"></img>
                   <p class="mr-96 relative right-96 bottom-8 text-gray-500">Start Discusion</p>
                   <hr class="relative bottom-6 ml-36" style={{width:650}}></hr>
                   <img src="./assets/user.png" class="ml-20"></img>
                   <p class="mr-80 relative right-96 bottom-8 text-gray-500">How To Upload file in AWS</p>
                   <p class="mr-96 relative right-32 bottom-8 text-gray-500">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor <br></br>
                   ...
                   <p class="mr-70 relative left-74 text-gray-500"><u>30 Replys</u></p>
                   
                    <IoArrowUndo style={{fontSize:30}} class="ml-36 relative bottom-8"/>
                    <p class="text-gray-500 mr-96 relative right-96 bottom-14">Reply</p>
                    <img src="./Assets/user.png" class="ml-20"></img>
                    <p class="mr-80 relative right-96 bottom-8 text-gray-500">How To Upload file in AWS</p>
                   <p class="mr-96 relative  right-32 bottom-8 text-gray-500">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor <br></br>
                    invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et</p>
                   ...
                   <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 ml-20 rounded-l-3xl relative bottom-40 right-16" style={{marginLeft:804}}>Have a doubt?Rise a query</button>
               ...
               <div class="ml-96 relative left-96  bg-gray-100 bottom-52" style={{width:250,height:100,position:"relative",bottom:1200,left:590}}>
                ...
                <img src="./Assets/signout.jpg" class="w-8 bg-gray-500 mt-2 ml-2 relative left-80"></img>
