    ...
    return (
        <div>
            ...
            <div class="h-16 relative bottom-10 bg-blue-100">
                ...
                <p class="ml-50 relative right-96 bottom-2 text-gray-500">Your Upcoming Class at 28-04-20 IST 5:30pm</p>
                <button class="w-36 p-1 relative bottom-10 bg-blue-500 text-white" style={{ marginLeft: 900 }}>Join Class</button>
            </div>
            <div>
                <p class="mr-96 text-sm relative right-96">Recorded Classes</p>
            </div>
            ...
            <div>
                <h1 class="font-bold ml-20  mr-96 relative right-96">Project 1: Server Management on AWS</h1>
                <p class="ml-18 mt-2  relative right-96 text-gray-500">This Project will showcase how to Host Static Application on AWS with best practices</p>
                <p class="mr-56  relative right-96 text-gray-500">Concepts Used : VPC, EC2, ELB, ASG, CloudWatch, SNS</p>
                <img src="./Assets/download.png" class="ml-20 mt-2 bg-blue-600"></img>
                <h1 class="mr-96 relative right-96 bottom-6 text-gray-500">Download Project Files</h1>
                <hr class="border border-gray-300 ml-20" style={{ width: 900 }}></hr>
                <h1 class="font-bold ml-20 mt-4 mr-96 relative right-96">Project 1: Server Management on AWS</h1>
                <p class="ml-18 mt-2 text-gray-500 relative right-96">This Project will showcase how to Host Static Application on AWS with best practices</p>
                <p class="mr-56 relative right-96 text-gray-500">Concepts Used : VPC, EC2, ELB, ASG, CloudWatch, SNS</p>
                <img src="./Assets/download.png" class="ml-20 mt-2 bg-blue-600"></img>
                <h1 class="mr-96 relative right-96 bottom-6 text-gray-500">Download Project Files</h1>
            </div>
            <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 ml-32 rounded-l-3xl relative bottom-10 left-2" style={{ marginLeft: 902 }}>Have a doubt?Rise a query</button>
            <img src="./Assets/green.png" class="w-2 relative  bottom-16 left-60" style={{ marginLeft: 900 }}></img>
        </div>
    );
};
