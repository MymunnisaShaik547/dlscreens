...
const Page23 = () => {
    return (
        <div style={{ height: 300 }}>
            ...
            <div style={{ width: 150, height: 250 }} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
            ...
            <div style={{ width: 700, height: 350 }} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
                <h1 class="text-gray-500 ml-54 mt-16">VERIFY CERTIFICATE</h1><br></br>
                ...
                <button class="text-white mt-10 text-sm ml-54 w-40 p-2 bg-blue-500">Verify</button>
            </div>
