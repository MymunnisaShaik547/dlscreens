...
const Page22 = () => {
    return (
       ...
       <div style={{width:750,height:450}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
           <img src="./Assets/amazon.png" class="w-36 ml-20 mt-10"></img>
           <p class="ml-86 relative bottom-16 text-gray-800">AWS</p>
           <hr class="border-4 border-blue-500 rounded-xl ml-72 relative bottom-12" style={{width:400}}></hr>
           <p class="text-gray-800 ml-96 relative left-12 bottom-10">100% Course Completed</p>
           <p class="ml-72 relative mt-2 bottom-10 text-sm text-blue-500"><u>DOWNLOAD CERTIFICATE</u></p>
           <p class="ml-96 relative left-28 mt-4 bottom-20 text-sm text-gray-500"><u>VERIFY CERTIFICATE</u></p>
           <hr style={{width:580}} class="ml-20 relative bottom-10"></hr>
           <div class="relative bottom-16">
           <img src="./Assets/python.png" class="w-36 ml-20 mt-10"></img>
           <p class="ml-84 relative bottom-16 text-gray-800">Python</p>
           ...
           <p class="text-gray-800 ml-96 relative left-12 bottom-10">40% Course Completed</p>
           <p class="text-gray-500 ml-96 text-sm relative left-10 bottom-8">You can Download Certificate after<br></br>
