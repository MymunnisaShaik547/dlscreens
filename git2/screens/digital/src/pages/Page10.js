    ...
    return (
        <div>
            <div class="w-screen">
                ...
                <img src="./Assets/user.png" style={{ marginLeft: 1120 }} class="relative left-72 bottom-28 w-8"></img>
            </div>
            <div class="h-16 relative bottom-10 bg-blue-100">
                <BsClock class="ml-44 relative top-4" style={{ fontSize: 30 }} color="gray" />
                <p class="mr-34 relative right-96 bottom-2 text-gray-500">Your Upcoming Class at 28-04-20 IST 5:30pm</p>
            ...
            <div >
                <p class=" mr-24 relative right-96 text-gray-500">Rate:</p>
            ...
            <div class="relative  bottom-24">
                ...
                <p class="mr-96 relative right-96 bottom-8 text-gray-500">Write a Review</p>
                <hr class="relative bottom-6 ml-36" style={{ width: 650 }}></hr>
                <p class="ml-96 relative right-40 bottom-14 text-blue-500">submit</p>
            </div>
            ...
            <img src="./Assets/green.png" class="w-2 relative left-60 bottom-28" style={{ marginLeft: 900 }}></img>
        </div>
    );
};
