...
const Page16 = () => {
    return (
        <div>
            ...
            <div>
                <p class="mr-96 text-sm relative right-72">Recorded Classes</p>
            </div>
            ...
            <div className='w-1/2'>
                   <h1 class="font-bold text-xl ml-12 mt-4 relative right-32">Programming Assignment: Linear Regression</h1>
                   <p class="ml-20 mt-6 text-gray-500 relative right-40">Dead Line : Pass this assignment by May 5, 12:00pm IST</p>
                   <p class="ml-20 text-gray-500 mt-4 relative right-80">Instructions</p>
                   <p class="ml-56 relative right-72 bottom-6 text-gray-500">View Solution</p>
                   ...
                   <p class="ml-20 text-gray-500 relative right-36">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam<br></br>
                    ...
                    <p class="ml-20 text-gray-500 mt-8 relative right-36"> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam <br></br>
